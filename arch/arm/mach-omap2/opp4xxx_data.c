...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITRO_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPOC1_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPOC1_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1008000000, OMAP4430_VDD_MPU_OPPNITRO_UV),
        /* MPU OPP4 - OPP-SB */
        OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1008000000, OMAP4430_VDD_MPU_OPPOC1_UV),
	/* L3 OPP1 - OPP50 */
...
#define OMAP4460_VDD_MPU_OPPOC1_UV    		1291000
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOC1_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0),
};

#define OMAP4460_VDD_IVA_OPP50_UV		 875000
#define OMAP4460_VDD_IVA_OPP100_UV		 950000
#define OMAP4460_VDD_IVA_OPPTURBO_UV		1114000
#define OMAP4460_VDD_IVA_OPPNITRO_UV		1292000
#define OMAP4460_VDD_IVA_OPPOC1_UV              1380000
...
struct omap_volt_data omap446x_vdd_iva_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPNITRO_UV, OMAP44XX_CONTROL_FUSE_IVA_OPPNITRO, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPOC1_UV, OMAP44XX_CONTROL_FUSE_IVA_OPPNITRO, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0),
};

#define OMAP4460_VDD_CORE_OPP10_UV		 650000
...
static struct omap_vdd_dep_volt omap446x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPOC1_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
};
